...
means that there is a gap between data A and B for isoform i within gene g, 

$$\rho_{gi}<1$$

means that there is an overlap between data A and B for isoform i within gene g. 
